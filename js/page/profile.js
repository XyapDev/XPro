...
async function addRoProInfo(tier, user_since, subscribed_for) {
	...
	if (header != undefined && await fetchSetting("roproBadge")) {
		...
		<div style="text-align:center;"><a style="font-size:13px;" href="${link}">XPro User for ${stripTags(user_since)}</a></div></div></div></div>`
